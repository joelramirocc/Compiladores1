    ...
    while (true) {
        switch (state) {
            ...
            case State::comments_q1:
                ...
                break;
            case State::comments_q10:
                if (ch == 'd') {
                    text += ch;
                    state = State::comments_q11;
                    ch = getNextChar();
                }
                else {
                    // Trying next automaton 'number
                ...
                break;
            case State::comments_q11:
                if (ch == 'e') {
                    text += ch;
                    state = State::comments_q12;
                    ch = getNextChar();
                }
                else {
                    // Trying next automaton 'number
                ...
                break;
            case State::comments_q12:
                if (ch == 'f') {
                    text += ch;
                    state = State::comments_q13;
                    ch = getNextChar();
                }
                else {
                    // Trying next automaton 'number
                ...
                break;
            case State::comments_q13:
                if (ch == ' ') {
                    text += ch;
                    state = State::comments_q14;
                    ch = getNextChar();
                }
                else {
                    // Trying next automaton 'number
                ...
                break;
            case State::comments_q14:
                if (((ch >= 'O') && (ch <= 'Z')) || ((ch >= 'A') && (ch <= 'M'))) {
                    text += ch;
                    state = State::comments_q37;
                    ch = getNextChar();
                }
                else if (ch == 'N') {
                    text += ch;
                    state = State::comments_q15;
                    ch = getNextChar();
                }
                else {
                    // Trying next automaton 'number
                ...
                break;
            case State::comments_q15:
                if (ch == 'A') {
                    text += ch;
                    state = State::comments_q16;
                    ch = getNextChar();
                }
                else {
                    state = State::comments_q37;
                ...
                break;
            case State::comments_q16:
                if (ch == 'N') {
                    text += ch;
                    state = State::comments_q17;
                    ch = getNextChar();
                }
                else {
                    text += ch;
                ...
                break;
            case State::comments_q17:
                if (ch == 'O') {
                    text += ch;
                    state = State::comments_q18;
                    ch = getNextChar();
                }
                else {
                    text += ch;
                ...
                break;
            case State::comments_q18:
                if (ch == 'P') {
                    text += ch;
                    state = State::comments_q19;
                    ch = getNextChar();
                }
                else {
                    text += ch;
                ...
                break;
            case State::comments_q19:
                if (ch == 'A') {
                    text += ch;
                    state = State::comments_q20;
                    ch = getNextChar();
                }
                else {
                    text += ch;
            ...
            case State::comments_q2:
                ...
                break;
            case State::comments_q20:
                if (ch == 'S') {
                    text += ch;
                    state = State::comments_q21;
                    ch = getNextChar();
                }
                else {
                    text += ch;
                ...
                break;
            case State::comments_q21:
                if (ch == 'C') {
                    text += ch;
                    state = State::comments_q22;
                    ch = getNextChar();
                }
                else {
                    text += ch;
                ...
                break;
            case State::comments_q22:
                if (ch == 'A') {
                    text += ch;
                    state = State::comments_q23;
                    ch = getNextChar();
                }
                else {
                    text += ch;
                ...
                break;
            case State::comments_q23:
                if (ch == 'L') {
                    text += ch;
                    state = State::comments_q24;
                    ch = getNextChar();
                }
                else {
                    text += ch;
            ...
            case State::comments_q24:
                ...
                break;
            case State::comments_q25:
                if (ch == 'n') {
                    text += ch;
                    state = State::comments_q33;
                    ch = getNextChar();
                }
                else if (ch == 'l') {
                    text += ch;
                    state = State::comments_q26;
                    ch = getNextChar();
                }
                else {
                    // Trying next automaton 'number
                ...
                break;
            case State::comments_q26:
                if (ch == 's') {
                    text += ch;
                    state = State::comments_q27;
                    ch = getNextChar();
                }
                else {
                    // Trying next automaton 'number
                ...
                break;
            case State::comments_q27:
                if (ch == 'e') {
                    text += ch;
                    state = State::comments_q28;
                    ch = getNextChar();
                }
                else {
                    // Trying next automaton 'number
                ...
                break;
            case State::comments_q28:
                if (ch == '}') {
                    text += ch;
                    state = State::comments_q29;
                    ch = getNextChar();
                }
                else {
                    // Trying next automaton 'number
                ...
                break;
            case State::comments_q29:
                if (ch == '{') {
                    text += ch;
                    state = State::comments_q30;
                    ch = getNextChar();
                }
                else {
                    state = State::comments_q29;
            ...
            case State::comments_q3:
                state = State::start_q0;
                break;
            case State::comments_q30:
                if (ch == '$') {
                    text += ch;
                    state = State::comments_q31;
                    ch = getNextChar();
                }
                else {
                    state = State::comments_q29;
                ...
                break;
            case State::comments_q31:
                if (ch == 'e') {
                    text += ch;
                    state = State::comments_q32;
                    ch = getNextChar();
                }
                else {
                    state = State::comments_q29;
            ...
            case State::comments_q32:
                ...
                break;
            case State::comments_q33:
                if (ch == 'd') {
                    text += ch;
                    state = State::comments_q34;
                    ch = getNextChar();
                }
                else {
                    state = State::comments_q29;
                ...
                break;
            case State::comments_q34:
                if (ch == 'i') {
                    text += ch;
                    state = State::comments_q35;
                    ch = getNextChar();
                }
                else {
                    state = State::comments_q29;
                ...
                break;
            case State::comments_q35:
                if (ch == 'f') {
                    text += ch;
                    state = State::comments_q36;
                    ch = getNextChar();
                }
                else {
                    state = State::comments_q29;
            ...
            case State::comments_q37:
                ...
                break;
            case State::comments_q38:
                if (ch == '{') {
                    text += ch;
                    state = State::comments_q40;
                    ch = getNextChar();
                }
                else {
                    text += ch;
                    state = State::comments_q39;
                    ch = getNextChar();
                }
                break;
            case State::comments_q39:
                if (ch == '{') {
                    text += ch;
                    state = State::comments_q40;
                    ch = getNextChar();
                ...
                break;
            case State::comments_q4:
                if (ch == 'e') {
                    text += ch;
                    state = State::comments_q25;
                    ch = getNextChar();
                }
                else if (ch == 'i') {
                    text += ch;
                ...
                break;
            case State::comments_q40:
                if (ch == '$') {
                    text += ch;
                    state = State::comments_q4;
                    ch = getNextChar();
                }
                else {
                    // Trying next automaton 'number
